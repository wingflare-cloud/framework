...
public class RoleSearchBo extends BaseSearchBo
{
		...
		private String like_roleGroupId;

        private String liker_roleGroupId;

        private String likel_roleGroupId;

        private String notlike_roleGroupId;

        private String notliker_roleGroupId;

        private String notlikel_roleGroupId;
		
        private String in_roleGroupId;

        private String notin_roleGroupId;

        private String eq_parentRoleId;

        private String neq_parentRoleId;
		
		private String like_parentRoleId;

        private String liker_parentRoleId;

        private String likel_parentRoleId;

        private String notlike_parentRoleId;

        private String notliker_parentRoleId;

        private String notlikel_parentRoleId;
		
        private String in_parentRoleId;

        private String notin_parentRoleId;

        private String eq_roleIdPath;

        private String neq_roleIdPath;
		
		private String like_roleIdPath;

        private String liker_roleIdPath;

        private String likel_roleIdPath;

        private String notlike_roleIdPath;

        private String notliker_roleIdPath;

        private String notlikel_roleIdPath;
		
        private String in_roleIdPath;

        private String notin_roleIdPath;
        ...
        public RoleSearchBo setEq_roleGroupId(String eq_roleGroupId)
        {
        ...
        public RoleSearchBo setNeq_roleGroupId(String neq_roleGroupId)
        {
            this.neq_roleGroupId = neq_roleGroupId;
            return this;
        }
		
        public String getLike_roleGroupId()
        {
            return like_roleGroupId;
        }

        public RoleSearchBo setLike_roleGroupId(String like_roleGroupId)
        {
            this.like_roleGroupId = like_roleGroupId;
            return this;
        }

        public String getLiker_roleGroupId()
        {
            return liker_roleGroupId;
        }

        public RoleSearchBo setLiker_roleGroupId(String liker_roleGroupId)
        {
            this.liker_roleGroupId = liker_roleGroupId;
            return this;
        }

        public String getLikel_roleGroupId()
        {
            return likel_roleGroupId;
        }

        public RoleSearchBo setLikel_roleGroupId(String likel_roleGroupId)
        {
            this.likel_roleGroupId = likel_roleGroupId;
            return this;
        }

        public String getNotlike_roleGroupId()
        {
            return notlike_roleGroupId;
        }

        public RoleSearchBo setNotlike_roleGroupId(String notlike_roleGroupId)
        {
            this.notlike_roleGroupId = notlike_roleGroupId;
            return this;
        }

        public String getNotliker_roleGroupId()
        {
            return notliker_roleGroupId;
        }

        public RoleSearchBo setNotliker_roleGroupId(String notliker_roleGroupId)
        {
            this.notliker_roleGroupId = notliker_roleGroupId;
            return this;
        }

        public String getNotlikel_roleGroupId()
        {
            return notlikel_roleGroupId;
        }

        public RoleSearchBo setNotlikel_roleGroupId(String notlikel_roleGroupId)
        {
            this.notlikel_roleGroupId = notlikel_roleGroupId;
            return this;
        }
        ...
        public RoleSearchBo setIn_roleGroupId(String in_roleGroupId)
        {
        ...
        public String getEq_parentRoleId()
        {
            return eq_parentRoleId;
        }

        public RoleSearchBo setEq_parentRoleId(String eq_parentRoleId)
        {
            this.eq_parentRoleId = eq_parentRoleId;
            return this;
        }

        public String getNeq_parentRoleId()
        {
            return neq_parentRoleId;
        }

        public RoleSearchBo setNeq_parentRoleId(String neq_parentRoleId)
        {
            this.neq_parentRoleId = neq_parentRoleId;
            return this;
        }
		
        public String getLike_parentRoleId()
        {
            return like_parentRoleId;
        }

        public RoleSearchBo setLike_parentRoleId(String like_parentRoleId)
        {
            this.like_parentRoleId = like_parentRoleId;
            return this;
        }

        public String getLiker_parentRoleId()
        {
            return liker_parentRoleId;
        }

        public RoleSearchBo setLiker_parentRoleId(String liker_parentRoleId)
        {
            this.liker_parentRoleId = liker_parentRoleId;
            return this;
        }

        public String getLikel_parentRoleId()
        {
            return likel_parentRoleId;
        }

        public RoleSearchBo setLikel_parentRoleId(String likel_parentRoleId)
        {
            this.likel_parentRoleId = likel_parentRoleId;
            return this;
        }

        public String getNotlike_parentRoleId()
        {
            return notlike_parentRoleId;
        }

        public RoleSearchBo setNotlike_parentRoleId(String notlike_parentRoleId)
        {
            this.notlike_parentRoleId = notlike_parentRoleId;
            return this;
        }

        public String getNotliker_parentRoleId()
        {
            return notliker_parentRoleId;
        }

        public RoleSearchBo setNotliker_parentRoleId(String notliker_parentRoleId)
        {
            this.notliker_parentRoleId = notliker_parentRoleId;
            return this;
        }

        public String getNotlikel_parentRoleId()
        {
            return notlikel_parentRoleId;
        }

        public RoleSearchBo setNotlikel_parentRoleId(String notlikel_parentRoleId)
        {
            this.notlikel_parentRoleId = notlikel_parentRoleId;
            return this;
        }

        public String getIn_parentRoleId()
        {
            return in_parentRoleId;
        }

        public RoleSearchBo setIn_parentRoleId(String in_parentRoleId)
        {
            this.in_parentRoleId = in_parentRoleId;
            return this;
        }

        public String getNotin_parentRoleId()
        {
            return notin_parentRoleId;
        }

        public void setNotin_parentRoleId(String notin_parentRoleId)
        {
            this.notin_parentRoleId = notin_parentRoleId;
        }

        public String getEq_roleIdPath()
        {
            return eq_roleIdPath;
        }

        public RoleSearchBo setEq_roleIdPath(String eq_roleIdPath)
        {
            this.eq_roleIdPath = eq_roleIdPath;
            return this;
        }

        public String getNeq_roleIdPath()
        {
            return neq_roleIdPath;
        }

        public RoleSearchBo setNeq_roleIdPath(String neq_roleIdPath)
        {
            this.neq_roleIdPath = neq_roleIdPath;
            return this;
        }
		
        public String getLike_roleIdPath()
        {
            return like_roleIdPath;
        }

        public RoleSearchBo setLike_roleIdPath(String like_roleIdPath)
        {
            this.like_roleIdPath = like_roleIdPath;
            return this;
        }

        public String getLiker_roleIdPath()
        {
            return liker_roleIdPath;
        }

        public RoleSearchBo setLiker_roleIdPath(String liker_roleIdPath)
        {
            this.liker_roleIdPath = liker_roleIdPath;
            return this;
        }

        public String getLikel_roleIdPath()
        {
            return likel_roleIdPath;
        }

        public RoleSearchBo setLikel_roleIdPath(String likel_roleIdPath)
        {
            this.likel_roleIdPath = likel_roleIdPath;
            return this;
        }

        public String getNotlike_roleIdPath()
        {
            return notlike_roleIdPath;
        }

        public RoleSearchBo setNotlike_roleIdPath(String notlike_roleIdPath)
        {
            this.notlike_roleIdPath = notlike_roleIdPath;
            return this;
        }

        public String getNotliker_roleIdPath()
        {
            return notliker_roleIdPath;
        }

        public RoleSearchBo setNotliker_roleIdPath(String notliker_roleIdPath)
        {
            this.notliker_roleIdPath = notliker_roleIdPath;
            return this;
        }

        public String getNotlikel_roleIdPath()
        {
            return notlikel_roleIdPath;
        }

        public RoleSearchBo setNotlikel_roleIdPath(String notlikel_roleIdPath)
        {
            this.notlikel_roleIdPath = notlikel_roleIdPath;
            return this;
        }

        public String getIn_roleIdPath()
        {
            return in_roleIdPath;
        }

        public RoleSearchBo setIn_roleIdPath(String in_roleIdPath)
        {
            this.in_roleIdPath = in_roleIdPath;
            return this;
        }

        public String getNotin_roleIdPath()
        {
            return notin_roleIdPath;
        }

        public void setNotin_roleIdPath(String notin_roleIdPath)
        {
            this.notin_roleIdPath = notin_roleIdPath;
        }
