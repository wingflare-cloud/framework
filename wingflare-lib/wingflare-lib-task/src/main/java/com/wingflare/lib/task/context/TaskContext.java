...
public class TaskContext {
    ...
    private static InheritableThreadLocal<TaskContext> contextHolder = new InheritableThreadLocal<TaskContext>(); // support for child thread of job handler)

    public static void setXxlJobContext(TaskContext taskContext){
        contextHolder.set(taskContext);
    }

    public static TaskContext getXxlJobContext(){
