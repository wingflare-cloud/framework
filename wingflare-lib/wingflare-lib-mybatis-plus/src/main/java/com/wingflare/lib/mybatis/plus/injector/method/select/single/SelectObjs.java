 ...
 * @since 2018-04-06
 */
public class SelectObjs extends CustomAbstractMethod {

    public SelectObjs() {
        super(CustomMethod.SELECT_OBJS.getMethod());
    }
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        CustomMethod sqlMethod = CustomMethod.SELECT_OBJS;
        ...
        return this.addSelectMappedStatementForOther(mapperClass, sqlSource, Object.class);
    }
}
