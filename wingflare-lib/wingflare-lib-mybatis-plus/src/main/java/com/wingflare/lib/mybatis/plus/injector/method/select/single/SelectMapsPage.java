 ...
 * @since 2018-04-06
 */
public class SelectMapsPage extends CustomAbstractMethod {

    public SelectMapsPage() {
        super(CustomMethod.SELECT_MAPS_PAGE.getMethod());
    }
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        CustomMethod sqlMethod = CustomMethod.SELECT_MAPS_PAGE;
        ...
        return this.addSelectMappedStatementForOther(mapperClass, sqlSource, Map.class);
    }
}
