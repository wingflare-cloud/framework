 ...
 * @since 2018-04-06
 */
public class DeleteById extends CustomAbstractMethod {

    public DeleteById() {
        super(CustomMethod.DELETE_BY_ID.getMethod());
    }
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        String sql;
        CustomMethod sqlMethod = CustomMethod.LOGIC_DELETE_BY_ID;
        if (tableInfo.isWithLogicDelete()) {
            ...
            sqlMethod = CustomMethod.DELETE_BY_ID;
