package com.wingflare.engine.task.server.web.model.enums;
...
public enum DateTypeEnum {
    ...
    DateTypeEnum(Consumer<List<DashboardLineResponseVO>> consumer, Function<LocalDateTime, LocalDateTime> startTime, Function<LocalDateTime, LocalDateTime> endTime) {
    ...
    public void setStartTime(Function<LocalDateTime, LocalDateTime> startTime) {
        this.startTime = startTime;
    }
    ...
    public void setEndTime(Function<LocalDateTime, LocalDateTime> endTime) {
        this.endTime = endTime;
    }
