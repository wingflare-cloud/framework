package com.wingflare.engine.task.server.common.appender;
 ...
 * @since 2.6.0
 */
public class TaskEngineServerLogbackAppender<E> extends UnsynchronizedAppenderBase<E> {
    ...
    protected void append(E eventObject) {
        ...
        try {
            ...
            TaskEngineLog.LOCAL.error("Log parsing failed. Msg:[{}]", event.getFormattedMessage(), e);
        }
