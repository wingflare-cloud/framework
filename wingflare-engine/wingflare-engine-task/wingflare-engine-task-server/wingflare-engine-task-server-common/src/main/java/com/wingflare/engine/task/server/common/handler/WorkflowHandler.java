...
import com.wingflare.engine.task.server.common.vo.WorkflowDetailResponseVO.NodeConfig;
import com.wingflare.engine.task.server.common.vo.WorkflowDetailResponseVO.NodeInfo;
...
public class WorkflowHandler {
    ...
    public NodeConfig buildNodeConfig(MutableGraph<Long> graph,
        ...
        currentConfig.getConditionNodes().sort(Comparator.comparing(NodeInfo::getPriorityLevel));
