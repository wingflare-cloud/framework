...
import com.wingflare.engine.task.common.core.enums.ServerStatusEnum;
...
import com.wingflare.engine.task.server.common.enums.DashboardLineEnum;
...
import com.wingflare.engine.task.server.common.register.UpdateClientRegister;
import com.wingflare.engine.task.server.web.model.base.PageResult;
import com.wingflare.engine.task.server.web.model.enums.DateTypeEnum;
...
import com.wingflare.engine.task.server.web.model.response.DashboardRetryLineResponseVO.Task;
...
import com.wingflare.engine.task.server.web.service.convert.*;
...
import com.wingflare.task.datasource.template.persistence.dataobject.DashboardRetryLineResponseDO;
...
public class DashboardServiceImpl implements DashboardService {
    ...
    public DashboardRetryLineResponseVO retryLineList(LineQueryVO queryVO) {
        ...
        List<Task> taskList = JobSummaryResponseVOConverter.INSTANCE.convertList(page.getRecords());
    ...
    public DashboardRetryLineResponseVO jobLineList(JobLineQueryVo queryVO) {
        ...
        List<Task> taskList = JobSummaryResponseVOConverter.INSTANCE.convertList(taskIPage.getRecords());
        PageResult<List<Task>> pageResult = new PageResult<>(
                new PageDTO(pager.getCurrent(), pager.getSize(), pager.getTotal()),
                taskList);
        responseVO.setTaskList(pageResult);
    ...
    public Boolean updatePodsStatus(ServerNodeStatusUpdateRequestVO updateRequestVO) {
        ...
        Assert.notNull(serverNode, () -> new TaskServerException("ServerNode not found."));
        ...
        Assert.notNull(statusEnum, () -> new TaskServerException("ServerNodeStatus not existed"));
        ...
        Assert.isTrue(updated, () -> new TaskServerException("update labels error"));
        return updated;
    }
