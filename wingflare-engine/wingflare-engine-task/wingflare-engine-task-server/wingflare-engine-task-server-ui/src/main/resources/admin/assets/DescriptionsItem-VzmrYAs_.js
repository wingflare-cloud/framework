import{b8 as p,b9 as e,da as F,db as G,by as H,ba as C,bx as M,d as E,dc as K,aj as n,dd as N,de as W,bb as Y,bc as L,df as q,a as B,bM as O,be as J,bY as Q}from"./index-CUlM8ApJ.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
