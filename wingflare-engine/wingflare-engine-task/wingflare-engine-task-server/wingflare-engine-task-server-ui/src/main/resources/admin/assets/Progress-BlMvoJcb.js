import{d as z,aj as r,bz as W,dQ as j,dR as q,dS as O,dT as T,a as x,dU as w,b8 as P,b9 as s,ba as C,bb as _,bc as G,dV as A,bM as N,be as M}from"./index-CUlM8ApJ.js";const L={success:r(T,null),error:r(O,null),warning:r(q,null),info:r(j,null)},X=z({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:p}){function u(n,o,t,l){const{gapDegree:c,viewBoxWidth:f,strokeWidth:y}=e,d=50,g=0,h=d,i=0,a=2*d,$=50+y/2,S=`M ${$},${$} m ${g},${h}
      a ${d},${d} 0 1 1 ${i},-100
