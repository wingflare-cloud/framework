...
import com.wingflare.engine.task.datasource.template.persistence.dataobject.JobBatchSummaryResponseDO;
...
public class JobSummarySchedule extends AbstractSchedule implements Lifecycle {
    ...
    protected void doExecute() {
        try {
            ...
            TaskEngineLog.LOCAL.error("job summary dashboard log error", e);
        }
    }
