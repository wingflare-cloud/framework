...
import com.wingflare.engine.task.common.core.exception.AbstractError;
 ...
 */
@ControllerAdvice(basePackages = {"com.wingflare.engine.task.server"})
@ResponseBody
public class RestExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler({BaseTaskException.class})
    public Result onBusinessException(BaseTaskException ex) {
        log.error("Exception class businessException", ex);
        if (ex instanceof final TaskAuthenticationException authenticationException) {
