...
public final class TaskLogManager {
    ...
    private static final TaskThreadLocal<LogTypeEnum> LOG_TYPE = snailJobLogContextLoader();
    private static final TaskThreadLocal<LogMeta> LOG_META = snailJobLogContextLoader();

    private static <T> TaskThreadLocal<T> snailJobLogContextLoader() {
