package com.wingflare.engine.task.client.retry.loader;
...
import com.wingflare.engine.task.client.retry.event.SimpleTaskRetryListener;
import com.wingflare.engine.task.client.retry.event.TaskListener;
import com.wingflare.engine.task.client.retry.expression.ExpressionInvocationHandler;
import com.wingflare.engine.task.client.retry.intercepter.ThreadLockRetrySiteSnapshotContext;
import com.wingflare.engine.task.client.retry.serializer.ForySerializer;
import com.wingflare.engine.task.client.retry.serializer.FurySerializer;
...
public class TaskRetrySpiLoader {
     ...
     * 若配置多个则只加载第一个
     *
     * @return {@link com.wingflare.engine.task.client.retry.serializer.JacksonSerializer} 默认序列化类为FurySerializer
     */
     ...
     * 加载指定名称的参数序列化SPI类
     *
     * @return {@link com.wingflare.engine.task.client.retry.serializer.JacksonSerializer} 默认序列化类为JacksonSerializer
     */
