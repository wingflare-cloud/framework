package com.wingflare.engine.task.client.retry.report;
...
import com.wingflare.engine.task.client.retry.Report;
...
public abstract class AbstractReport implements Report {
    ...
    protected RetryTaskRequest buildRetryTaskDTO(final String scene, final String targetClassName, final Object[] args) {
        ...
        try {
            ...
            idempotentId = (String) ReflectionUtil.invokeMethod(method, generate, idempotentIdContext);
