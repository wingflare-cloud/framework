package com.wingflare.engine.task.client.core.cache;
    ...
    public static ThreadPoolExecutor createThreadPool(Long taskBatchId, int parallelNum) {
        ...
        Supplier<ThreadPoolExecutor> supplier = () -> {
            ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(
                    ...
                    Container.get(ThreadPoolManageDrive.class)
                            .factory(MessageFormat.format("wingflare-task-job-{0}-", taskBatchId)));
