package com.wingflare.engine.task.client.spring.starter.retry.intercepter;
 ...
 * @date 2023-08-23
 */
public class TaskRetryPointcutAdvisor extends AbstractPointcutAdvisor implements IntroductionAdvisor, BeanFactoryAware, InitializingBean {
    private Advice advice;
    private Pointcut pointcut;
    private BeanFactory beanFactory;
    private MethodInterceptor methodInterceptor;

    public TaskRetryPointcutAdvisor(MethodInterceptor methodInterceptor) {
