...
public class SystemProperties {
    ...
    public SystemProperties(int retryPullPageSize, int retryMaxPullParallel, int jobPullPageSize, int serverPort, String serverHost, String serverToken, int maxDispatchCapacity, int logStorage, int mergeLogDays, int mergeLogNum, int loadBalanceCycleTime, int bucketTotal, int summaryDay, RpcTypeEnum rpcType, SnailJobMailProperties mail, RpcClientProperties clientRpc, RpcServerProperties serverRpc) {
