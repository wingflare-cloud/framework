...
public class MailAccount implements Serializable {
    ...
    public Properties getSmtpProps() {
        ...
        if (null != this.sslEnable && this.sslEnable) {
            ...
            if (this.sslProtocols != null && !this.sslProtocols.isBlank()) {
    ...
    public String toString() {
        return "MailAccount [host=" + host + ", port=" + port + ", auth=" + auth + ", user=" + user + ", pass=" + (this.pass.isEmpty() ? "" : "******") + ", from=" + from + ", startttlsEnable="
