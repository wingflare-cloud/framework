...
(
    ...
    `role_group_id`  bigint(20) unsigned   NOT NULL DEFAULT '0' COMMENT '角色分组id',
    `parent_role_id` bigint(20) unsigned   NOT NULL DEFAULT '0' COMMENT '父级角色id',
    `role_id_path`   varchar(256) NOT NULL DEFAULT '' COMMENT '角色id层级路径',
