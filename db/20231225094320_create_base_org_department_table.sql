...
(
    ...
    `parent_department_id` bigint(20) unsigned  NOT NULL DEFAULT '0' COMMENT '父级部门',
    `department_name`      varchar(256) NOT NULL DEFAULT '' COMMENT '部门名称',
    `role_id`              bigint(20) unsigned  NOT NULL DEFAULT '0' COMMENT '部门基础角色id',
    `user_id`              bigint(20) unsigned  NOT NULL DEFAULT '0' COMMENT '部门主要负责人id',
