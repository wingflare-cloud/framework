...
public class RoleWrapper
{
     ...
     * @param bo 查询条件
     */
    public static QueryWrapper<RoleDo> getQueryWrapper(RoleSearchBo bo) {
        ...
        if (StringUtil.isNotEmpty(bo.getLike_roleGroupId())) {
            queryWrapper.like("role_group_id", bo.getLike_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_roleGroupId())) {
            queryWrapper.likeRight("role_group_id", bo.getLiker_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_roleGroupId())) {
            queryWrapper.likeLeft("role_group_id", bo.getLikel_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_roleGroupId())) {
            queryWrapper.notLike("role_group_id", bo.getNotlike_roleGroupId());
        }
        ...
        // parent_role_id 开始
        if (bo.getEq_parentRoleId() != null) {
            queryWrapper.eq("parent_role_id", bo.getEq_parentRoleId());
        }
        if (bo.getNeq_parentRoleId() != null) {
            queryWrapper.ne("parent_role_id", bo.getNeq_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getLike_parentRoleId())) {
            queryWrapper.like("parent_role_id", bo.getLike_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_parentRoleId())) {
            queryWrapper.likeRight("parent_role_id", bo.getLiker_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_parentRoleId())) {
            queryWrapper.likeLeft("parent_role_id", bo.getLikel_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_parentRoleId())) {
            queryWrapper.notLike("parent_role_id", bo.getNotlike_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getIn_parentRoleId())) {
            WrapperUtil.in(queryWrapper, "parent_role_id", bo.getIn_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_parentRoleId())) {
            WrapperUtil.notIn(queryWrapper, "parent_role_id", bo.getNotin_parentRoleId());
        }
        // role_id_path 开始
        if (bo.getEq_roleIdPath() != null) {
            queryWrapper.eq("role_id_path", bo.getEq_roleIdPath());
        }
        if (bo.getNeq_roleIdPath() != null) {
            queryWrapper.ne("role_id_path", bo.getNeq_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getLike_roleIdPath())) {
            queryWrapper.like("role_id_path", bo.getLike_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_roleIdPath())) {
            queryWrapper.likeRight("role_id_path", bo.getLiker_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_roleIdPath())) {
            queryWrapper.likeLeft("role_id_path", bo.getLikel_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_roleIdPath())) {
            queryWrapper.notLike("role_id_path", bo.getNotlike_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getIn_roleIdPath())) {
            WrapperUtil.in(queryWrapper, "role_id_path", bo.getIn_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_roleIdPath())) {
            WrapperUtil.notIn(queryWrapper, "role_id_path", bo.getNotin_roleIdPath());
        }
        // role_name 开始
        if (bo.getEq_roleName() != null) {
            queryWrapper.eq("role_name", bo.getEq_roleName());
        }
        if (bo.getNeq_roleName() != null) {
            queryWrapper.ne("role_name", bo.getNeq_roleName());
        }
        if (StringUtil.isNotEmpty(bo.getLike_roleName())) {
            queryWrapper.like("role_name", bo.getLike_roleName());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_roleName())) {
            queryWrapper.likeRight("role_name", bo.getLiker_roleName());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_roleName())) {
            queryWrapper.likeLeft("role_name", bo.getLikel_roleName());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_roleName())) {
            queryWrapper.notLike("role_name", bo.getNotlike_roleName());
        }
        if (StringUtil.isNotEmpty(bo.getIn_roleName())) {
            WrapperUtil.in(queryWrapper, "role_name", bo.getIn_roleName());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_roleName())) {
            WrapperUtil.notIn(queryWrapper, "role_name", bo.getNotin_roleName());
        }
        // role_remark 开始
        if (bo.getEq_roleRemark() != null) {
            queryWrapper.eq("role_remark", bo.getEq_roleRemark());
        }
        if (bo.getNeq_roleRemark() != null) {
            queryWrapper.ne("role_remark", bo.getNeq_roleRemark());
        }
        if (StringUtil.isNotEmpty(bo.getLike_roleRemark())) {
            queryWrapper.like("role_remark", bo.getLike_roleRemark());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_roleRemark())) {
            queryWrapper.likeRight("role_remark", bo.getLiker_roleRemark());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_roleRemark())) {
            queryWrapper.likeLeft("role_remark", bo.getLikel_roleRemark());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_roleRemark())) {
            queryWrapper.notLike("role_remark", bo.getNotlike_roleRemark());
        }
        if (StringUtil.isNotEmpty(bo.getIn_roleRemark())) {
            WrapperUtil.in(queryWrapper, "role_remark", bo.getIn_roleRemark());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_roleRemark())) {
            WrapperUtil.notIn(queryWrapper, "role_remark", bo.getNotin_roleRemark());
        }
        // created_time 开始
	...
	public static LambdaQueryWrapper<RoleDo> getLambdaQueryWrapper(RoleSearchBo bo) {
        ...
        // role_group_id 开始
        if (bo.getEq_roleGroupId() != null) {
            queryWrapper.eq(RoleDo::getRoleGroupId, bo.getEq_roleGroupId());
        }
        if (bo.getNeq_roleGroupId() != null) {
            queryWrapper.ne(RoleDo::getRoleGroupId, bo.getNeq_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getLike_roleGroupId())) {
            queryWrapper.like(RoleDo::getRoleGroupId, bo.getLike_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_roleGroupId())) {
            queryWrapper.likeRight(RoleDo::getRoleGroupId, bo.getLiker_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_roleGroupId())) {
            queryWrapper.likeLeft(RoleDo::getRoleGroupId, bo.getLikel_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_roleGroupId())) {
            queryWrapper.notLike(RoleDo::getRoleGroupId, bo.getNotlike_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getIn_roleGroupId())) {
            WrapperUtil.in(queryWrapper, RoleDo::getRoleGroupId, bo.getIn_roleGroupId());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_roleGroupId())) {
            WrapperUtil.notIn(queryWrapper, RoleDo::getRoleGroupId, bo.getNotin_roleGroupId());
        }
        // parent_role_id 开始
        if (bo.getEq_parentRoleId() != null) {
            queryWrapper.eq(RoleDo::getParentRoleId, bo.getEq_parentRoleId());
        }
        if (bo.getNeq_parentRoleId() != null) {
            queryWrapper.ne(RoleDo::getParentRoleId, bo.getNeq_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getLike_parentRoleId())) {
            queryWrapper.like(RoleDo::getParentRoleId, bo.getLike_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_parentRoleId())) {
            queryWrapper.likeRight(RoleDo::getParentRoleId, bo.getLiker_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_parentRoleId())) {
            queryWrapper.likeLeft(RoleDo::getParentRoleId, bo.getLikel_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_parentRoleId())) {
            queryWrapper.notLike(RoleDo::getParentRoleId, bo.getNotlike_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getIn_parentRoleId())) {
            WrapperUtil.in(queryWrapper, RoleDo::getParentRoleId, bo.getIn_parentRoleId());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_parentRoleId())) {
            WrapperUtil.notIn(queryWrapper, RoleDo::getParentRoleId, bo.getNotin_parentRoleId());
        }
        // role_id_path 开始
        if (bo.getEq_roleIdPath() != null) {
            queryWrapper.eq(RoleDo::getRoleIdPath, bo.getEq_roleIdPath());
        }
        if (bo.getNeq_roleIdPath() != null) {
            queryWrapper.ne(RoleDo::getRoleIdPath, bo.getNeq_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getLike_roleIdPath())) {
            queryWrapper.like(RoleDo::getRoleIdPath, bo.getLike_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getLiker_roleIdPath())) {
            queryWrapper.likeRight(RoleDo::getRoleIdPath, bo.getLiker_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getLikel_roleIdPath())) {
            queryWrapper.likeLeft(RoleDo::getRoleIdPath, bo.getLikel_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getNotlike_roleIdPath())) {
            queryWrapper.notLike(RoleDo::getRoleIdPath, bo.getNotlike_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getIn_roleIdPath())) {
            WrapperUtil.in(queryWrapper, RoleDo::getRoleIdPath, bo.getIn_roleIdPath());
        }
        if (StringUtil.isNotEmpty(bo.getNotin_roleIdPath())) {
            WrapperUtil.notIn(queryWrapper, RoleDo::getRoleIdPath, bo.getNotin_roleIdPath());
        }
        // role_name 开始
        if (bo.getEq_roleName() != null) {
