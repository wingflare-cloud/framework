...
import com.wingflare.task.admin.core.trigger.TaskTrigger;
...
public class JobTriggerPoolHelper {
    ...
    public void start(){
        fastTriggerPool = new ThreadPoolExecutor(
                10,
                TaskAdminConfig.getAdminConfig().getTriggerPoolFastMax(),
                60L,
                TimeUnit.SECONDS,
        ...
        slowTriggerPool = new ThreadPoolExecutor(
                10,
                TaskAdminConfig.getAdminConfig().getTriggerPoolSlowMax(),
                60L,
                TimeUnit.SECONDS,
     ...
     * add trigger
     */
    public void addTrigger(final int taskId,
        ...
        triggerPool_.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    // do trigger
                    TaskTrigger.trigger(taskId, triggerType, failRetryCount, executorShardingParam, executorParam, addressList);
                } catch (Throwable e) {
            ...
            public String toString() {
                return "Job Runnable, taskId:"+taskId;
            }
        });
    }
     ...
     */
    public static void trigger(int taskId, TriggerTypeEnum triggerType, int failRetryCount, String executorShardingParam, String executorParam, String addressList) {
        helper.addTrigger(taskId, triggerType, failRetryCount, executorShardingParam, executorParam, addressList);
    }
