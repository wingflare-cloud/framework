...
public class ExecutorRouteLFU extends ExecutorRouter {
    ...
    public String route(int taskId, List<String> addressList) {
        ...
        // lfu item init
        HashMap<String, Integer> lfuItemMap = jobLfuMap.get(taskId);     // Key排序可以用TreeMap+构造入参Compare；Value排序暂时只能通过ArrayList；
        if (lfuItemMap == null) {
            lfuItemMap = new HashMap<String, Integer>();
            jobLfuMap.putIfAbsent(taskId, lfuItemMap);   // 避免重复覆盖
        }
