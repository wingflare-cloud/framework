    ...
    <div class="content">
      <div class="container">
        ...
        <el-table :data="userConfig.outputFiles" border style="width: 100%">
          ...
          <el-table-column prop="pkgSuffix" label="包名后缀"></el-table-column>
      ...
      <el-dialog :visible.sync="showEditForm" width="70%" top="5vh">
        <el-tabs v-model="activeName">
          <el-tab-pane label="基本配置" name="base">
            <el-form ref="editForm" :rules="rules" :model="form" label-width="120px">
              ...
              <el-form-item
                  label="包后缀"
                  prop="pkgSuffix"
                  placeholder="包后缀，分层结构的项目中非常有用"
              >
                <el-input v-model="form.pkgSuffix"></el-input>
              </el-form-item>
              <el-form-item label="包名" prop="outputLocationPkg" placeholder="例如：org.example.do">
                <el-input v-model="form.outputLocationPkg" placeholder="org.example.do">
                  <el-select
          ...
          <el-tab-pane label="策略配置" name="strategy" v-if="form.builtIn">
            <do-strategy-form v-if="form.fileType=='Do'" :user-config="userConfig"></do-strategy-form>
...
import DoStrategyForm from "@/components/DoStrategyForm";
