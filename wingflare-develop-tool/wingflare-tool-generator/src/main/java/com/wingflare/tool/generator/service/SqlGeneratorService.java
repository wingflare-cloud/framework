...
import com.wingflare.tool.generator.dto.*;
import com.wingflare.tool.generator.mbp.TemplateEngine;
import com.wingflare.tool.generator.sqlparser.ConditionExpr;
...
import static com.wingflare.tool.generator.dto.Constant.DOT_XML;
...
public class SqlGeneratorService {
    ...
    public MapperElement createResultMapElement(GenDtoConfig config) {
        ...
        String resultMapStr = templateEngine.write2String(tplParams, "classpath:codetpls/resultMap.btl");
    ...
    public MapperElement createMapperMethodElement(String sql, GenDtoConfig config) {
        ...
        String methodEleStr = templateEngine.write2String(tplParams, "classpath:codetpls/mapperMethods.btl");
    ...
    private void genDtoFromConfig(GenDtoConfig config) throws Exception {
        ...
        templateEngine.writer(tplParams, "classpath:codetpls/dto.btl", new File(outputPath));
